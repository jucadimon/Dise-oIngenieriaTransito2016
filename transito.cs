...
///////////////////////////////////////////////
        struct ProyectoTransito
        {
            ...
            public List<Interseccion_Vial> Lista_Intersecciones_Viales;
        }
        struct Interseccion_Vial
        {
            public string Nombre;
            public int IDInterseccion;
            public bool flag;
            public List<Acceso_Vial> Lista_Accesos_Viales;
        }
        struct Acceso_Vial
        {
            public string Nombre_AccesoVial;//N--S, E--W, S--N, W--E
            public int IDAccesoVial;
            public int Numero_Carriles;
            public double Ancho_Calzada;
            public List<Carril_Vial> Lista_Carriles_Viales;
        }
        struct Carril_Vial
        {
            public string NombreCarrilVial;//izq, der, centro
            public double Ancho_Carril;
            public int Numero_Movimientos;
            public List<Movimiento_Vial> Lista_Movimientos_Viales;
        }
        struct Movimiento_Vial
        {
            public string Nombre_Movimiento_Vial;//giro izq, giro der y directo.
            public Aforo_Vial Aforo_Movimiento;
        }
        struct Aforo_Vial
        {
            public string Nombre;
            ...
            public Composicion_Vehicular Composicion_Aforo;//recibe como parametro y crea la lista de veh_mixtos
            // devuelve un metodo previo
            public double porcentaje_Buses;
            public double porcentaje_Camiones;
            public double porcentaje_Automoviles;
            public double porcentaje_Motos;
            //Devuelve el metodo como resultado.
        ...
        struct Composicion_Vehicular
        {
            public string subperiodo;
            public int Motos, Automoviles, Buses, Camiones, Peatones;
        }
/////////////////////////////////////////////////////
